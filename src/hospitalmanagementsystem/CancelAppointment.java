...
public class CancelAppointment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "appointmentid", "DoctorName", "Date", "Time", "ContactNumber", "PatientName", "PatientEmail"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jTextField1.setFont(new java.awt.Font("Segoe UI Semibold", 1, 12)); // NOI18N
        jTextField1.setText("Enter id to cancel appointment");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tm.setRowCount(0);
        while(rs.next()){
            Object o[]={rs.getInt("appointmentid"),rs.getString("DoctorName"),rs.getString("Date"),rs.getString("Time"),rs.getString("ContactNumber"),rs.getString("PatientName"),rs.getString("PatientEmail")};
            tm.addRow(o);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
             ...
             Statement st = conn.createStatement();
             String sql ="Delete FROM `appointment`WHERE appointmentid="+remove; //doctor enters id to cancel appointment
             PreparedStatement ptst = conn.prepareStatement(sql);
             ptst.executeUpdate();
